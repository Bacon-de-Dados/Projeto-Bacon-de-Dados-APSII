 ...
 <jsp:include page="header.html"></jsp:include>
    <main>
        ...
        <section id="titulo">
            ...
            <p class="text-center text-secondary mr-5 ml-5"> Somos uma lanchonete criada por estudantes de Análise e
                Desenvolvimento de Sistemas,
                da Universidade Cruzeiro do Sul - Unidade Paulista
            </p>
            <p class="text-center text-secondary mr-5 ml-5">Criamos a lanchonete após um intervalo das aulas na unidade,
            ...
            <p class="text-center text-secondary mr-5 ml-5">Com base nisso criamos a Bacon de Dados, uma lanchonete que
                além de ter os pratos mais gostosos de São Paulo, possui um ambiente
        ...
        <section id="titulo">
            ...
            <p class="text-center text-secondary mr-5 ml-5">Nosso estabelecimento está localizado no coração da
                cidade.</p>
        </section>
